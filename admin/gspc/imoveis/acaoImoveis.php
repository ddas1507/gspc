...
/************************************************************************/	
	if($acao == 'detalhesImoveis-consulta-servicos-alterar'){
		$oquefazer->detalhesImoveis();
		$oquefazer->formularioAlterarTabelaTarefas();
		require('detalhesImoveis-consulta-servicos-alterar.php');
	}
/************************************************************************/	
	...
	if($acao == 'gravarAlteracaosImoveisServicos'){
		$oquefazer->gravarAlteracaosImoveisServicos();
		$oquefazer->detalhesImoveis();
		$oquefazer->listarTarefasServicos();
		require('detalhesImoveis-consulta-servicos.php');
	}
	...
	if($acao == 'status-desfazer-tarefas-detalhes-processos'){
	...
	if($acao == 'detalhesImoveis-consulta-processos-editar'){
		$oquefazer->listarTarefasProcessos2();
		require('detalhesImoveis-consulta-processos-editar.php');
	}
	
	if($acao == 'detalhesImoveis-consulta-processos-alterar'){
		$oquefazer->formularioAlterarTabelaTarefasProcessos();
		$oquefazer->detalhesImoveis();
		$oquefazer->listarTarefasProcessos();		
		require('detalhesImoveis-consulta-processos.php');
	}

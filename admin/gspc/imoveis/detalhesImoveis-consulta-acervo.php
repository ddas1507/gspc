		...
		<td valign="top" style=" border: 1px solid #ccc; width: 65%; background: #fff;">
			<table border="0" style=" width: 100%; padding: 15px; font-size: 12px;">
				...
				<tr style=" font-size: 12px; ">
					...
					<td class="titulo-tabelas" colspan="2">Opc&atilde;o</td>
				</tr>
				<?php
				...
				<tr class="dadostabelas" onmouseover="this.className='dadostabelasOver'" onmouseout="this.className='dadostabelas'" >
					...
					<td >
						...
						&nbsp;
						<a href="javascript:if(confirm('ATEN&Ccedil;&Atilde;O!!!\nVoc&ecirc; deseja excluir o documento abaixo?\n\nDocumento: <?php echo $acervo_descricao;?>\nN&uacute;mero: <?php echo $acervo_numero;?>\nData de Cadastro: <?php echo $img_dtcad;?>\nVencimento:<?php echo $acervo_dtvencimento;?>')) {location='index.php?tabela=excluirAcervo&acao=excluirAcervo&acervo_codigo=<? echo $acervo_codigo;?>&clicod=<? echo $clicod;?>&imocod=<? echo $imocod;?>';}">
							<img src="images/others/delete.png" border="0" width="24px" alt="Excluir Documento" title="Excluir Documento" />
						</a>						
					</td>
				</tr>
				<?php

...
<table class="imoveis-fundo-dados-gerais">
	<tr>
		...
		<td style="color:#069; font-weight:bold; height: 40px;font-size: 12px; width: 25%;">Dados da Unidade</td>
		<td style="color:#069; font-weight:bold; height: 40px;font-size: 12px; width: 4%;">&nbsp;</td>
	...
	<tr>
		...
		<table class="tabelas-consulta" >
				<tr>
					...
					<td class="titulo-tabelas">Valor de emolumentos</td>
				...
				<?php
					while($oquefazer->registros = $oquefazer->resultado->FetchNextObject())
					{
						...
						$dataprocesso	= $oquefazer->registros->DATATAREFA;						
						...
						$emolumentos	= $oquefazer->registros->TAR_EMOLUMENTOS_VALOR;
				...
				<tr class="dadostabelas" onmouseover="this.className='dadostabelasOver'" onmouseout="this.className='dadostabelas'" >
					<td class="dados-tabelas"><?echo $dataprocesso;?></td>
					<td class="dados-tabelas" title="<?php echo $processo;?>" alt="<?php echo $processo;?>"><?echo $servico;?></td>
					<td class="dados-tabelas"><?echo $emolumentos;?></td>
					<td class="dados-tabelas"><?echo $honorarios;?></td>
					...
					<td class="dados-tabelas">
						<a href="index.php?tabela=status-confirmar-tarefas-detalhes-processos&acao=status-confirmar-tarefas-detalhes-processos&imocod=<? echo $imocod;?>&tarcodigo=<? echo $tarcodigo;?>&clicod=<? echo $clicod;?>">
			...
			<tr>
				<table width="100%" style=" font-size: 12px;" border="0" >
					...
					<tr>
						<td style="color:#069; font-weight:bold; height: 40px;font-size: 12px; width: 25%;">Detalhes do processo:</td>

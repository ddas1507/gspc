		...
		<td valign="top" style=" border: 1px solid #ccc; width: 65%; background: #fff;">
			<table border="0" style=" width: 100%; padding: 15px; font-size: 12px;">
				...
				<tr>
					...
					<td class="titulo-tabelas" colspan="2">Op&ccedil;&otilde;es</td>
				</tr>
				<?php
					while($oquefazer->registros = $oquefazer->resultado->FetchNextObject())
					{
						$img_codigo	= $oquefazer->registros->IMG_CODIGO;
				...
				<tr class="dadostabelas" onmouseover="this.className='dadostabelasOver'" onmouseout="this.className='dadostabelas'" >
					<td class="dados-tabelas"><? echo $img_codigo;?></td>
					...
					<td class="dados-tabelas">
						<a href="index.php?tabela=&acao=&imocod=<? echo $imocod;?>&clicod=<? echo $clicod;?>">
							Baixar
						</a>
					</td>
				</tr>

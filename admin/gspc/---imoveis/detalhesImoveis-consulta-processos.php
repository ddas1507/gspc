		...
		<table class="tabelas-consulta" >
			...
			<tr>
				<table width="100%" style=" font-size: 12px;" border="0" >
					...
					<tr>
						<td style="color:#069; font-weight:bold; height: 40px;font-size: 12px; width: 25%;">
					...
					<tr>
						...
						<td><b>Percentual de conclus&atilde;o:&nbsp;</b>
						<?php 
							$total =  $oquefazer->totalDeTarefasConcluidas();//4
							$media = 100 / $total;
							if($total == 0){
								echo '0';
							}
						...
						<td><b>Status:&nbsp;</b><?php if($media < 100){echo '<label style=color:#990000;>Em andamento</label>';}else{echo '<label style=color:#009900;>Conclu&iacute;do</label>';}?></td>
					</tr>
				</table>
			</tr>
		</table>	

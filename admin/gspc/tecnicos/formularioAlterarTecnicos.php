	...
	<table class="tabelas-cadastro">
							...
							<td>
								<select name="tec_nivel" id="tec_nivel">
									<?php
										...
										switch($oquefazer->registros->TEC_NIVEL)
										{
									...
									<option value="2" <?php echo $tec;?>>T&eacute;cnico</option>
								</select>
							</td>
						</tr>					
					<?
		...
		<tr >
			<td colspan="2">
				...
				/>
				<input type="hidden" value="gravarAlteracaoTecnicos" name="tabela"/>
				<input type="hidden" value="gravarAlteracaoTecnicos" name="acao"/>

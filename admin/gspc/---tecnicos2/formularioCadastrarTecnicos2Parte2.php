...
<div id="corpo-tabela">
	<table class="tabelas-consulta" cellspacing="0" cellpadding="0" border="0" class="display" id="listagem">
		...
		<tbody>
			...
			?>
				<tr onclick="location.href = 'index.php?tabela=formularioCadastrarTecnicos2Parte3&acao=formularioCadastrarTecnicos2Parte3&ref_imovel=<? echo $ref_imovel;?>&codigo_imovel=<? echo $codigo_imovel;?>&nome_imovel=<? echo $nome_imovel;?>&clicod=<? echo $codigo_cliente;?>&nome_cliente=<? echo $nome_cliente;?>&img_cliente=<? echo $img_cliente;?>';" style="cursor: pointer;line-height: 25px;" class="dadostabelas" onmouseover="this.className='dadostabelasOver'" onmouseout="this.className='dadostabelas'" >

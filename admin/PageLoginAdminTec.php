...
<table border="0" class="login-table">
	<form method="post" action="login_validacaoAdminTec.php" >
		<tr><td align="center"><center><img src="gspc/images/others/logo.png" class="login-logo" style="margin: 15px;"/></center></td></tr>
		<tr><td class="login-frase"><label >Seja bem-vindo!<br /> Por favor, realize a autentica&ccedil;&atilde;o</label></td></tr>

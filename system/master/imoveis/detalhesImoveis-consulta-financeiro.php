	...
	<tr>
		...
		<td style="color:#069; font-weight:bold; height: 40px;font-size: 12px; width: 65%;">
			<table style=" width: 100%; ">
				<tr>
					<td align="left">Resumo financeiro</td>
					<td>
		...
		<table class="tabelas-consulta" >
				...
				<?php
					while($oquefazer->registros = $oquefazer->resultado->FetchNextObject())
					{
						...
						$valorHonorarios	= $oquefazer->registros->TAR_HONORARIOS_VALOR;
				...
				?>
				<tr onclick="location.href = 'index.php?tabela=detalhesImoveis-consulta-servicos-financeiro&acao=detalhesImoveis-consulta-servicos-financeiro&imocod=<? echo $imocod;?>&nprocesso=<? echo $nprocesso;?>&clicod=<? echo $clicod;?>';" style="cursor: pointer;" class="dadostabelas" onmouseover="this.className='dadostabelasOver'" onmouseout="this.className='dadostabelas'" title="clique para visualizar os valores dos servi&ccedil;os ">
					<td class="dados-tabelas"><?echo $dataprocessodia.'/'.$dataprocessomes.'/'.$dataprocessoano;?></td>
					<td class="dados-tabelas" ><?echo $processo;?></td>
					<td class="dados-tabelas" ><?echo 'R$ '.$valorHonorarios;?></td>

<?php $codigo_cliente = $_REQUEST['codigo_cliente'];?>
		...
		<form name="formularioCadastrarTarefasConferencia" action="index.php" method="post" enctype="multipart/form-data">
			<td>
				<table width="100%" >
					...
					<tr><td class="tabela-dados-labels" >Servi&ccedil;o:</td><td class="tabela-dados-visualizar"><? echo $nome_servico;?></td></tr>
					...
					<tr><td class="tabela-dados-labels" >Valor de emolumentos:</td><td class="tabela-dados-visualizar"><? echo 'R$ '.$valor_emolumentos;?></td></tr>
					<tr>
						<td colspan="2" >
							<input 
							...
							<input type="hidden" value="<? echo $nome_servico;?>" name="tar_servico_nome"/>
							<input type="hidden" value="<? echo $nome_tecnico;?>" name="tar_tecnico_nome"/>
							
							<input type="hidden" value="<? echo $codigo_cliente;?>" name="tar_cliente_codigo"/>
							<input type="hidden" value="<? echo $codigo_imovel;?>" name="tar_imovel_codigo"/>
							...
							<input type="hidden" value="<? echo $valor_emolumentos;?>" name="tar_emolumentos_valor"/>
						</td>
					</tr>
				</table>
			</td>

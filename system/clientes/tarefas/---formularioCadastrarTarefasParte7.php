...
<table class="tabelas-consulta" >	
	...
	<tr class="dadostabelas" onmouseover="this.className='dadostabelasOver'" onmouseout="this.className='dadostabelas'" >
		<form name="formularioCadastrarTarefasEmolumentos" action="index.php" method="post" enctype="multipart/form-data">
			<td class="dados-tabelas">
				<table >
					<tr>
						<td >
							Valor:&nbsp;
							<input type="text" name="valor_emolumentos" id="valor_emolumentos" placeholder="Digite o valor" onKeyPress="return(MascaraMoeda(this,'.',',',event))"  required="required" />&nbsp;
						</td>
						<td colspan="2" align="center">
							...
							<input type="hidden" value="<? echo $valor_honorarios;?>" name="valor_honorarios"/>
						</td>
					</tr>
				</table>
			</td>

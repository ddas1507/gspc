	...
	<tr>
		<td>
			<table style="width:100%;">
				...
				<tr><td class="tabela-dados-labels" >Senha:</td><td class="tabela-dados-visualizar"><label style="color:#036; font-weight:bold;">******</label></td></tr!>
				<tr><td class="tabela-dados-labels" >CPF:</td><td class="tabela-dados-visualizar">
				<?php

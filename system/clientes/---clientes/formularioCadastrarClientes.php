		...
		<tr>
			...
			<td valign="top">
				<fieldset class="conteudo-fielset"><legend class="titulo-fielset">Informa&ccedil;&otilde;es Governamentais</legend>
					<table>
						<tr><td>CNPJ-CPF/MF:</td><td><input type="text" name="cli_cnpj" id="cli_cnpj" size="30px" maxlength="30"  /></td></tr>
						<!--tr><td>Cnpj:</td><td><input type="text" name="cli_cnpj" id="cli_cnpj" size="30px" maxlength="14" /></td></tr-->
						<tr><td>Inscri&ccedil;&atilde;o Estadual:</td><td><input type="text" name="cli_inscricaoestadual" id="cli_inscricaoestadual" size="30px" maxlength="14" /></td></tr>
					</table>
				</fieldset>
			</td>
		</tr>

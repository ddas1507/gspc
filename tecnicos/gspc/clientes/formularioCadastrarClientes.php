				...
				<fieldset class="conteudo-fielset"><legend class="titulo-fielset">Dados Adicionais</legend>
					<table>
						<tr>
							...
							<td>Celular:</td>
							<td><input type="text" name="cli_telcel" id="cli_telcel" size="15px" maxlength="14" onkeyup="proximoCampo(this, 'cli_senha')" onkeypress="mascara(this, '##&nbsp;#&nbsp;####-####')"/></td>
							<td>Senha:</td>
							<td><input type="text" name="cli_senha" id="cli_senha" size="10" maxlength="6" onkeyup="proximoCampo(this, 'cli_senha')" /></td>
						</tr>
					</table>
				</fieldset>	
			</td>

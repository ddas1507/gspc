			...
			<td valign="top">
				<fieldset class="conteudo-fielset"><legend class="titulo-fielset">Acervo Digital</legend>
					<table>
						...
						<tr><td>Vencimento:</td><td><input type="text" name="acervo_dtvencimento" id="acervo_dtvencimento" size="15px" maxlength="10" onkeyup="proximoCampo(this, 'img_descricao')" onkeypress="mascara(this, '##/##/####')" /></td></tr>

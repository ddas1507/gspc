<?php
	class manutencaoTarefas{
		...
		function listarTarefas(){
			$sql = "select * FROM tbl_tarefasProcessos where TAR_TECNICO_CODIGO = ".$_SESSION['sessao_codigo_usuario'];
		...
		function listarTarefasConsultaProcessos(){$sql = "select * FROM tbl_tarefasProcessos where TAR_TECNICO_CODIGO = ".$_SESSION['sessao_codigo_usuario'];
		$this->resultado = $this->con->banco->Execute($sql);}

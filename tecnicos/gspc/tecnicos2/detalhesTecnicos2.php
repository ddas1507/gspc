		...
		<td align="left">
			<div id="navegacao-header">
				<ul>
					...
					<li>></li>
					<li><b>Consultar Tecnicos Cadastrados</b></li>
					<li>></li>
					<li>Perfil T&eacute;cnico do Cliente</li>
				</ul>
			</div>
		</td>
	</tr>
	...
	<tr>
		<td>
			<table style="width:100%;">
				...
				<tr><td class="tabela-dados-labels" >CPF:</td><td class="tabela-dados-visualizar"><?php echo $cpf;?>
